...
function generateResult() {
  ...
  const rm = rmRaw.replaceAll(',', '').replaceAll('.', ''); // hỗ trợ dấu , và .
  const sc = scCount;
  const eba = ebaCount;
...
// Trả về giá SC đúng với mã và tình trạng có DO hay không
...
// Trả về giá EBA đúng với mã và tình trạng có DO hay không
